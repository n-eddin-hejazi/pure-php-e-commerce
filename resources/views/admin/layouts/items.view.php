...
<li>
    <a href="<?= main_url() ?>/admin/users" class="text-sm flex items-center p-2 font-normal text-gray-900 rounded-md dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
